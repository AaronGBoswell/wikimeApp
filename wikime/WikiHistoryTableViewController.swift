//
//  WikiHistoryTableViewController.swift
//  wikime
//
//  Created by Aaron Boswell on 11/3/15.
...
class WikiHistoryTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return wikiMeController.wikiHistory.count
    }
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        performSegueWithIdentifier("showWebView", sender: indexPath)
    }
    /*
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let indexPath = sender as? NSIndexPath{
            if let dest = segue.destinationViewController as? WikiBrowserViewController{
                dest.displayHref = wikiMeController.wikiHistory[indexPath.row]["href"] as? String
            }
        }
